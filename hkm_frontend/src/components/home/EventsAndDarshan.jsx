  ...
  return (
            ...
            {upcomingEvents.map((ev, i) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-justify text-gray-600 dark:text-gray-300 leading-relaxed">{ev.description}</p>
    ...
    >
      ...
      <div className="my-4 pr-2">
        ...
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed border-t border-gray-200 dark:border-gray-700 pt-3 mb-1 text-justify">
        ...
        <div className="md:block">
          <AnimatePresence>
            {(isAboutExpanded || typeof window !== 'undefined' && window.innerWidth >= 768) && (
              ...
              >
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed border-t border-gray-200 dark:border-gray-700 pt-1 text-justify">
          ...
          >
            ...
            <div className="w-full lg:w-2/3 ">
              <div className="p-6 lg:p-8 lg:pr-12">
                ...
                {/* Scrollable Content */}
                <div className="my-4 pr-2">
                  <div className="text-gray-700 dark:text-gray-300 leading-relaxed border-t border-gray-200 pt-4">
