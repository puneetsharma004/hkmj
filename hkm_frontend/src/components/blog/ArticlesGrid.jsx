    ...
    >
      ...
      >
        <button
          ...
          className="px-4 py-2 bg-white/10 dark:bg-gray-900/80 text-gray-700 dark:text-gray-300 rounded-lg border border-orange-200 dark:border-purple-400 border-opacity-60 dark:border-opacity-30 disabled:opacity-50 disabled:cursor-not-allowed hover:border-saffron hover:border-opacity-80 dark:hover:border-opacity-50 transition-all duration-300 flex items-center gap-2 shadow-lg"
        >
          <FaChevronLeft />
          Previous
        </button>
