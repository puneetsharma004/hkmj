        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              <motion.button
                key={index}
                className="px-4 py-2 bg-gradient-to-r from-saffron to-gold text-black dark:text-white font-semibold rounded-lg hover:shadow-lg hover:shadow-saffron/30 transition-all duration-300 flex items-center gap-2"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                {option.icon}
